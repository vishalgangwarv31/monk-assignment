...
if(!JWT_SECRET) {
    throw new Error("missing jwt secret key for EMPLOYEE auth middleware")
}
...
export const employeeAuthMiddleware = ( req: Request , res : Response , next : NextFunction ) : void =>{
